...
public class InputValidationApplication {
	...
	private static final Logger LOGGER = LoggerFactory.getLogger(InputValidationApplication.class);
	...
	public static void main(String[] args) {
		SpringApplication application = new SpringApplication(InputValidationApplication.class);

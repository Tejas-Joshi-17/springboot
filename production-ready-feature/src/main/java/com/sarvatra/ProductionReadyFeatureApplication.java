...
public class ProductionReadyFeatureApplication {
    ...
    private static final Logger LOGGER = LoggerFactory.getLogger(ProductionReadyFeatureApplication.class);
    ...
    public static void main(String[] args) {
        SpringApplication application = new SpringApplication(ProductionReadyFeatureApplication.class);
